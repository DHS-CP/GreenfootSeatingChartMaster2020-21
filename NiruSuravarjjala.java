 ...
 * Then, it will bounce around like a spring and ask a question, if the answer is yes, it will provide a lesson and go back to its orignal position.
...
public class NiruSuravarjjala extends Student
{
     ...
     *  3,3 is the third cell down and third cell right from the upper left corner. 
     */
